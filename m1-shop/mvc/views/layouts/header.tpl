...
<head>
    ...
    <link rel="stylesheet" href="/m1-shop/web/bundles/dataTables/jquery.dataTables.min.css">
    ...
    <script type="text/javascript" src="/m1-shop/web/bundles/dataTables/jquery.dataTables.min.js"></script>
